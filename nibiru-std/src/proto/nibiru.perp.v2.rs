...
pub struct LiquidationFailedEvent {
    ...
    #[prost(
        enumeration = "liquidation_failed_event::LiquidationFailedReason",
        tag = "4"
    )]
    pub reason: i32,
}
    ...
    impl LiquidationFailedReason {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                LiquidationFailedReason::NonexistentPosition => {
...
pub struct GenesisState {
    ...
    pub custom_discounts:
        ::prost::alloc::vec::Vec<genesis_state::CustomDiscount>,
...
pub struct MsgMultiLiquidateResponse {
    #[prost(message, repeated, tag = "1")]
    pub liquidations: ::prost::alloc::vec::Vec<
        msg_multi_liquidate_response::LiquidationResponse,
    >,
}
